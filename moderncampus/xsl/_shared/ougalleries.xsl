...
-->
	<xsl:template match="gallery">
		...
		<xsl:choose>
			...
			<xsl:when test="$gallery-type = 'art-on-campus'">
				<div class="flex-box-gallery-wrapper">
					<xsl:for-each select="images/image">
						<a href="{link}" rel="prettyPhoto[{$gallery-id}]" title="{title}">
							<span class="flex-box-gallery-image">
								<img src="{thumbnail/@url}" alt="{title}" style="height:{thumbnail/height}px; width:{thumbnail/width}px;"/>
							</span>
							<span class="flex-box-gallery-text">
			...
			<xsl:when test="$gallery-type = 'slick-slider'">
				<div class="slider-wrapper">
							...
							<div class="slide">
                				<div class="carousel-caption-overlay">
                   					<div class="carousel-caption">
										...
										<a href="{link}" class="btn red-btn">More Information</a></div>
                					</div>
					...
					<div class="slide-controllers"><button class="pause-play" aria-label="Pause/Play" type="button"><span class="sr-only">Pause/Play</span></button></div>
					
				</div>
			</xsl:when>
			
			<xsl:when test="$gallery-type = 'slick-slider2'">
				<div class="slider-wrapper">
        			<div class="hero-slider">
			...
			<xsl:when test="$gallery-type = 'slick-slider-2024'">
				<section>
        			<div class="lpc-banner-bg">
												...
												<div class="carousel-caption-overlay">
													<xsl:if test="link != ''">
														<div class="carousel-caption">
															...
															<p><xsl:value-of select="description" /></p>
															<a href="{link}" class="btn red-btn">More Information</a>
                										</div>
													</xsl:if>
