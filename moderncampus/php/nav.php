...
function match_li($matches){
	...
	//else { 
		$html .= "<li class=\"list-group-item\"{$li_attributes}><a{$a_attributes_before}href=\"{$full_href}\"{$a_attributes_after}>{$title}</a></li>";
	//}	
}
...
function match_section_li($matches){
	...
	if ($process_nav) {
		...
		$html .= "<li{$li_attributes}><a{$a_attributes_before}href=\"{$href}{$page}\"{$a_attributes_after}>{$title}</a><ul class=\"level-{$nest_level}\">";
		...
		$html .= "<li{$li_attributes}><a{$a_attributes_before}href=\"{$href}{$page}\"{$a_attributes_after}>{$title}</a></li>";
	}	
}
?>