...
<xsl:stylesheet version="3.0" 
	...
	<!-- Contat Info Start 	 -->
	<xsl:param name="ou:contactinfo-start" />
		<xsl:variable name="contactinfo-start" select="if ($ou:contactinfo-start = '') then $dirname 
												  else (if (ends-with($ou:contactinfo-start, '/')) 
												  then $ou:contactinfo-start else concat($ou:contactinfo-start, '/'))"/>
	
	<!-- top banner image defaults -->
<!-- 	<xsl:param name="ou:first-banner-image"/>
	<xsl:param name="ou:first-banner-image-alt"/>
	
	<xsl:param name="ou:second-banner-image"/>
	<xsl:param name="ou:second-banner-image-alt"/>
	
	<xsl:param name="ou:third-banner-image"/>
	<xsl:param name="ou:third-banner-image-alt"/> -->
	
	<!-- top banner image defaults -->
	<xsl:param name="ou:top-banner-image"/>
	<xsl:param name="ou:top-banner-image-alt"/>
	<xsl:param name="ou:top-banner-image-link"/>
	
	<!-- faculty directory xml path -->
	<xsl:param name="ou:faculty-xml-path" />
	
	<!-- events feed -->
	<xsl:param name="ou:events-feed"/>
	...
	<xsl:variable name="page-lang" select="ou:pcf-param('page-lang')" />
